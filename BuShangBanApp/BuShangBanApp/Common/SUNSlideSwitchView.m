...
//                                      lineBreakMode:NSLineBreakByCharWrapping];
        ...
        if (i == 0) {
            if([_viewArray count]==2){
                if([buttonTitle isEqualToString:@"内容"]||[buttonTitle isEqualToString:@"用户"]){
                
                    if(iPhone5 || iPhone4)
                        _shadowImageView.frame = CGRectMake(50+10, 41,  _shadowImage.size.width, _shadowImage.size.height);
                    else if(iPhone6)
                        _shadowImageView.frame = CGRectMake(24+50, 41,  _shadowImage.size.width, _shadowImage.size.height);
                    else
                         _shadowImageView.frame = CGRectMake(24+55, 41,  _shadowImage.size.width, _shadowImage.size.height);
                }else if([buttonTitle isEqualToString:@"按时间排序"]||[buttonTitle isEqualToString:@"按赞数排序"]){
                
                    if(iPhone5 || iPhone4)
                         _shadowImageView.frame = CGRectMake(24+22, 41,  _shadowImage.size.width, _shadowImage.size.height);
                    else if(iPhone6)
                         _shadowImageView.frame = CGRectMake(24+40, 41,  _shadowImage.size.width, _shadowImage.size.height);
                    else//6p
                         _shadowImageView.frame = CGRectMake(24+36+9, 41,  _shadowImage.size.width, _shadowImage.size.height);
                }else
                     _shadowImageView.frame = CGRectMake(24+40, 41,  _shadowImage.size.width, _shadowImage.size.height);
            }
                ...
                _shadowImageView.frame = CGRectMake(24+25, 41,  _shadowImage.size.width, _shadowImage.size.height);
            }
        ...
        [UIView animateWithDuration:0.25 animations:^{
            ...
            if([_viewArray count]==2){
                ...
                if([buttonStr isEqualToString:@"内容"]||[buttonStr isEqualToString:@"用户"]){
                    if(iPhone5 || iPhone4){
                        [_shadowImageView setFrame:CGRectMake(sender.frame.origin.x+27, 41, _shadowImage.size.width, _shadowImage.size.height)];
                    }else if(iPhone6){
                        [_shadowImageView setFrame:CGRectMake(sender.frame.origin.x+44, 41,     _shadowImage.size.width, _shadowImage.size.height)];
                    }else
                        [_shadowImageView setFrame:CGRectMake(sender.frame.origin.x+50, 41,     _shadowImage.size.width, _shadowImage.size.height)];
                }else if([buttonStr isEqualToString:@"按时间排序"]||[buttonStr isEqualToString:@"按赞数排序"]){
                    if(iPhone5 || iPhone4)
                          [_shadowImageView setFrame:CGRectMake(sender.frame.origin.x+15, 41, _shadowImage.size.width, _shadowImage.size.height)];
                    else if(iPhone6)
                          [_shadowImageView setFrame:CGRectMake(sender.frame.origin.x+30, 41, _shadowImage.size.width, _shadowImage.size.height)];
                    else//6p
                        [_shadowImageView setFrame:CGRectMake(sender.frame.origin.x+34, 41, _shadowImage.size.width, _shadowImage.size.height)];
                }else
                    [_shadowImageView setFrame:CGRectMake(sender.frame.origin.x+30, 41, _shadowImage.size.width, _shadowImage.size.height)];
            }else if(iPhone5){
                //3个tab
                [_shadowImageView setFrame:CGRectMake(sender.frame.origin.x+7, 41, _shadowImage.size.width, _shadowImage.size.height)];
                 ...
                 [_shadowImageView setFrame:CGRectMake(sender.frame.origin.x+20, 41, _shadowImage.size.width, _shadowImage.size.height)];
            }
//            if([_viewArray count]==2){
//            
//                if([buttonStr isEqualToString:@"内容"]||[buttonStr isEqualToString:@"用户"]){
