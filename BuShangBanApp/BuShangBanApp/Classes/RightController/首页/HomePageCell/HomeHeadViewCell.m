...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _leftBigImageView.frame = CGRectMake(0, 0.5, kScreenWidth*0.68, kScreenWidth/414*260);
        ...
        _rightUpImageView.frame = CGRectMake(_leftBigImageView.right, 0.5, kScreenWidth*0.32, kScreenWidth/414*130);
